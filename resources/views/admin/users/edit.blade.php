        ...
        <div class="bg-white shadow-xl rounded-lg overflow-hidden">
            <form action="{{ route('admin.users.update', $user->id) }}" method="POST" class="p-6 sm:p-8">
                ...
                <div class="mb-8 flex items-center">
                    ...
                    <label for="is_admin" class="ml-2 block text-sm text-gray-700">Cấp quyền Admin</label>
                </div>

                <!-- Form actions -->
                <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-3">
                    <a href="{{ route('admin.users.index') }}" class="inline-flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
